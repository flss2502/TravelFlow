package io.github.flss2502.travelflow.utils;

import io.github.flss2502.travelflow.entities.UserEntity;
import io.github.flss2502.travelflow.exceptions.AppExceptions;
...
public class JWTUtils {
    ...
    public void verifyToken(String token, boolean isRefresh) throws ParseException, JOSEException {
        ...
        if (isTokenBlacklisted(token)) {
            throw new AppExceptions(ResponseEnum.TOKEN_INVALID);
        }
