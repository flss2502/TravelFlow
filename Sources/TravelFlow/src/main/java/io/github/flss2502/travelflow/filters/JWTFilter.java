package io.github.flss2502.travelflow.filters;

import io.github.flss2502.travelflow.exceptions.ErrorDetails;
import io.github.flss2502.travelflow.utils.JWTUtils;
...
public class JWTFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain) throws ServletException, IOException {
        ...
        for (Pair<String, String> bypass : bypassToken) {
            if (request.getServletPath().equals(bypass.getRight()) && request.getMethod().equals(bypass.getLeft())) {
